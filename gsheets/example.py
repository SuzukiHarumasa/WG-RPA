...
sys.path.append('/Users/suzukiharumasaru/apps/tools/pytools')

import pandas as pd
from gsheets import GSheets

# インスタンスを生成
creds = '/Users/suzukiharumasaru/apps/tools/pytools/py-tools-341712-6978522c6ff8.json'
gs = GSheets(creds)
